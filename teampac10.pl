...
% 'calcular distancia de manhatan de n posicoes até um destino Res no formato [(DistManatam, PosX, PosY)| ...]'
calcDistAll( _, [], [] ).
...
get_dir( id, pastilhas, N, (PacX, PacY), ( ObjX, ObjY ), [ [ (D, (X, Y)) | IR ] | OR ], Free, Gums, Dec ):-
	%write('aiai'), nl,
...
%pacman10(2,300,0,(3,7,1,270,0),(2,7,1,270,0),[(1,-8,1,90,0),(0,-8,1,90,0)],(8,1),(-9,1),[(-1,7),(0,5),(-9,-1),(5,7),(8,1),(2,-2),(0,7),(-2,-9),(-8,1),(-1,8),(7,3),(-1,-1),(-7,1),(4,4),(-1,-7),(1,-9),(2,-1),(-9,3),(-7,9),(-4,7),(-5,6),(-7,-1),(-8,-4),(2,2),(-1,-3),(4,-4),(-5,1),(0,-8),(-3,-3),(2,1),(0,4),(2,9),(0,-1),(-6,7),(-5,3),(0,1),(-5,-9),(-1,-4),(2,3),(-3,1),(-8,9),(6,5),(7,7),(1,-5),(-8,3),(6,-5),(6,-9),(3,-3),(-8,-9),(-3,0),(-3,-6),(-2,-5),(-8,5),(0,-5),(-7,-3),(-4,-3),(8,-1),(4,1),(4,8),(2,7),(-3,3),(-5,2),(-6,1),(-8,-5),(2,6),(6,3),(-3,7),(-6,-7),(3,7),(7,-1),(-8,-3),(6,9),(-4,-9),(-1,-8),(7,5),(6,-6),(-8,-8),(2,-7),(-2,-7),(0,9),(-8,8),(2,-3),(2,-6),(4,-6),(-5,-1),(-3,5),(-6,5),(-3,-7),(-1,3),(7,9),(1,-3),(-5,4),(-7,-7),(7,-5),(-7,3),(-8,-7),(1,5),(7,8),(-4,9),(4,-1),(-5,0),(5,5),(6,-1),(2,-9),(7,-9),(-4,1),(7,6),(-2,9),(7,-8),(6,1),(-5,-6),(-5,8),(-1,-9),(-7,5),(-4,-5),(4,0),(1,7),(-7,7),(0,-4),(4,-7),(4,-3),(-3,9),(7,-4),(4,3),(-5,7),(3,9),(5,-3),(2,5),(3,-5),(5,-7),(6,-3),(7,-3),(-2,3),(-7,-9),(4,-9),(0,8),(-8,6),(-2,5),(8,3),(-1,4),(-2,7),(3,1),(-2,-1),(-8,-1),(-1,1),(6,-7),(-5,-4),(-5,-5),(7,1),(-5,-7),(-5,-3),(4,-5),(-2,-3),(-1,9),(4,6),(5,1),(-5,9),(-7,-5),(-5,5),(-8,7),(0,-3),(-3,2),(1,9),(3,-9),(2,0),(1,-7),(1,-1),(4,5),(4,7),(4,-2),(0,3),(0,-9),(6,7),(4,9),(0,-7),(2,-5),(-1,-5),(-3,-5),(-9,1),(-7,-6),(-1,5),(4,2),(-3,-9),(5,-9),(7,-7),(-6,-3),(-3,-2),(-3,6),(-5,-2),(1,3),(-3,-1),(-6,-9),(5,9),(-6,9)],[(1,-9),(4,-5),(7,-9),(0,-8),(7,-8),(6,-9),(3,-3),(0,5),(0,-9),(0,-7),(2,-7),(6,5),(4,-6),(4,-9),(0,8),(7,6),(5,9),(4,0),(4,7),(2,-6),(2,-5),(4,-3),(6,-5),(6,7),(4,-7),(2,7),(0,7),(4,6),(4,-4),(1,7),(5,5),(4,2),(0,-4),(3,7),(3,-9),(1,9),(5,-9),(0,9),(5,-7),(3,-5),(5,7),(7,7),(6,-6),(7,-4),(4,9),(5,-3),(6,9),(4,1),(4,3),(7,5),(7,-7),(7,-3),(1,5),(4,8),(2,-3),(2,-9),(6,-7),(1,-5),(1,-7),(0,-3),(6,-3),(0,-5),(7,9),(4,4),(2,9),(1,-3),(4,-2),(4,-1),(3,9),(2,5),(2,6),(4,5)],[(7,8),(7,-5)],[(-2,-3),(-8,9),(-2,-7),(-5,-2),(-5,0),(-8,5),(-5,6),(-4,-3),(-7,5),(-1,-8),(-6,7),(-1,9),(-1,-9),(-3,7),(-8,7),(-7,7),(-5,-6),(-2,5),(-5,-4),(-5,5),(-3,-5),(-7,-9),(-1,5),(-5,-7),(-2,7),(-5,9),(-1,7),(-3,-6),(-5,-3),(-3,-3),(-6,5),(-1,-3),(-1,-5),(-6,-3),(-3,5),(-8,-7),(-3,6),(-3,-7),(-1,-7),(-7,-3),(-8,-3),(-6,-9),(-6,-7),(-1,-4),(-8,-4),(-7,9),(-2,-5),(-2,9),(-5,-1),(-5,-9),(-5,-5),(-5,7),(-8,-8),(-6,9),(-7,-7),(-4,-9),(-4,9),(-7,-6),(-4,7),(-8,-9),(-5,1),(-3,-9),(-5,2),(-1,8),(-7,-5),(-5,3),(-5,8),(-4,-5),(-8,6),(-3,9),(-2,-9),(-5,4)],[(-8,-5),(-8,8)],Decisao)
...
pacman10(1,_,_,(_,PacX,PacY,PacDir,_),_,_,_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao):-
	Decisao is 0.
%"pares com pares"
pacman10(N,_,_,(My1,PacX,PacY,PacDir,_),_,[(Other1,_,_,Dir,_),_],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	R is mod(My1,2), 
	R2 is mod(Other1,2),
	R2 < 1,
	N < 15,
	simetrico(Dir,Decisao).
pacman10(N,_,_,(My,PacX,PacY,PacDir,_),_,[_,(Other1,_,_,Dir,_)],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	R is mod(My,2),
	R < 1,
	R2 is mod(Other1,2),
	R2 < 1,
...
%"impares com impares"
pacman10(N,_,_,(_,PacX,PacY,PacDir,_),_,[_,(Other1,_,_,Dir,_)],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	R is mod(Other1,2),
	R > 0,
	N < 15,
	simetrico(Dir,Decisao).
pacman10(N,_,_,(_,PacX,PacY,PacDir,_),_,[(Other,_,_,Dir,_),_],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	R is mod(Other,2),
	R > 0,
	N < 15,
	simetrico(Dir,Decisao).
...
alerta((_,PosX,PosY,_), [(_,Inim1X, Inim1Y,_,M1),(_,Inim2X, Inim2Y,_,M2)], ListaDosInimigos ) :-
	M1 < 2;(M1)
	calcDistAll( (PosX,PosY), [(Inim1X, Inim1Y),(Inim2X, Inim2Y)], L),
	alertaFantasma(A), 
	appendCondicional(A,L,ListaDosInimigos). 
