...
pacman10(1,_,_,(_,PacX,PacY,PacDir,_),_,_,_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao):-
	Decisao is 0.
pacman10(N,_,_,(0,PacX,PacY,PacDir,_),_,[(2,_,_,Dir,_),_],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	N < 15,
	simetrico(Dir,Decisao).
pacman10(N,_,_,(0,PacX,PacY,PacDir,_),_,[_,(2,_,_,Dir,_)],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	N < 15,
	simetrico(Dir,Decisao).
	
pacman10(N,_,_,(1,PacX,PacY,PacDir,_),_,[_,(3,_,_,Dir,_)],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	N < 15,
	simetrico(Dir,Decisao).
pacman10(N,_,_,(1,PacX,PacY,PacDir,_),_,[(3,_,_,Dir,_),_],_,_,Free,_,_,Pastilhas,MaxPastilhas,Decisao) :-
	N < 15,
	simetrico(Dir,Decisao).

pacman10(_,_,_,(_,PacX,PacY,PacDir,_),_,_,_,_,Free,_,_,Pastilhas,MaxPastilhas,Dec) :-
