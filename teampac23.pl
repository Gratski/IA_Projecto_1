% ' Largura Primeiro -> Com inicio a ir cada um para quadrantes diferentes '
%factos dinamicos
:- dynamic last_pos/2.
:- dynamic pastilhas/1.
...
%sucessores
sucs( Cur, Free, CurTree, Visitados, Sucs ):-
	findall( Suc , ( viz( _, Cur, Suc ), member( Suc, Free ), \+member( Suc, Visitados ) ), Sucs).
...
%caso base
get_dir( Id, pastilhas, N, (PacX, PacY), ( ObjX, ObjY ), [ [ (D, (X, Y)) | IR ] | _ ], _, _, Gums, Dec ):-
	%write('Cucu'), nl,
...
%Pacman Id 0
%Largura Primeiro	
get_dir( Id, pastilhas, N, (PacX, PacY), ( ObjX, ObjY ), [ [ (D, (X, Y)) | IR ] | OR ], Visitados, Free, Gums, Dec ):-
	insere_em_vector( (X, Y), Visitados, NewVisitados ),
	%write('aiai'), nl,
	sucs( (X, Y), Free, [ (D, (X, Y)) | IR ], NewVisitados, Sucs ),
	%write('piupiu'), nl,
	...
	%write(NL), nl,
	%write('extra'), nl,
	get_dir(Id, pastilhas,NewN, (PacX, PacY), ( ObjX, ObjY ), NL, NewVisitados, Free, Gums, Dec ).

%Pacman Id 0
%Profundidade Primeiro	
/*get_dir( 1, pastilhas, N, (PacX, PacY), ( ObjX, ObjY ), [ [ (D, (X, Y)) | IR ] | OR ], Visitados, Free, Gums, Dec ):-
	insere_em_vector( (X, Y), Visitados, NewVisitados ),
	%write('aiai'), nl,
	sucs( (X, Y), Free, [ (D, (X, Y)) | IR ], NewVisitados, Sucs ),
	%write('piupiu'), nl,
